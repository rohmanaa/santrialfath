...
<div class="header header-fixed header-logo-center">
    ...
    <div class="page-content pb-0">
        ...
        <div class="card">
            ...
            <div class="content">
                <p class="font-600 mb-0 color-highlight">Berikan Saran dan Berkembang</p>
                <h1>Kontak Form</h1>
            </div>
            ...
            <div class="card contact-form">
                <div class="content">
                <form action="php/kontak.php" method="post" enctype='multipart/form-data'>
                        ...
                        <fieldset>
                            ...
                            <div class="form-field form-name">
                                ...
                                <input type="text" name="tglkontak" value=" <?= $tgll ?> " class="round-small" id="tglkontak" readonly />
                            </div>
                            ...
                            <div class="form-field form-text">
                                <label class="ket color-theme" for="pesan">Keterangan<span>(required)</span></label>
                                <textarea name="pesan" class="round-small" id="pesan" required></textarea>
                            </div>
                           
                            <button type="submit" name="kontak" class="btn bg-highlight text-uppercase font-900 btn-m btn-full rounded-sm  shadow-xl contactSubmitButton"><i class="fa fa-paper-plane pr-3"></i> Kirim</button>
